...
var TaskServiceGetTaskArgs_Req_DEFAULT *GetTaskReq

func (p *TaskServiceGetTaskArgs) GetReq() (v *GetTaskReq) {
	if !p.IsSetReq() {
		return TaskServiceGetTaskArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *TaskServiceGetTaskArgs) SetReq(val *GetTaskReq) {
	p.Req = val
}
...
func (p *TaskServiceGetTaskArgs) Field1DeepEqual(src *GetTaskReq) bool {
...
var TaskServiceGetTaskResult_Success_DEFAULT *GetTaskResp

func (p *TaskServiceGetTaskResult) GetSuccess() (v *GetTaskResp) {
	if !p.IsSetSuccess() {
...
func (p *TaskServiceGetTaskResult) Field0DeepEqual(src *GetTaskResp) bool {
...
var TaskServiceCreateTaskArgs_Req_DEFAULT *CreateTaskReq

func (p *TaskServiceCreateTaskArgs) GetReq() (v *CreateTaskReq) {
	if !p.IsSetReq() {
		return TaskServiceCreateTaskArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *TaskServiceCreateTaskArgs) SetReq(val *CreateTaskReq) {
	p.Req = val
}
...
func (p *TaskServiceCreateTaskArgs) Field1DeepEqual(src *CreateTaskReq) bool {
...
var TaskServiceCreateTaskResult_Success_DEFAULT *CreateTaskResp

func (p *TaskServiceCreateTaskResult) GetSuccess() (v *CreateTaskResp) {
	if !p.IsSetSuccess() {
...
func (p *TaskServiceCreateTaskResult) Field0DeepEqual(src *CreateTaskResp) bool {
